...
const deleteOthersRecord=async(req,res)=>{
    try {
        const deleteOffer = await others.findById(req.params.id);
...
module.exports={
    add_others , othersInsertData ,view_others ,deactive ,active , deleteOthersRecord
}